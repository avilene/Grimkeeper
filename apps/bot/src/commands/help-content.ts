    ...
    new EmbedBuilder()
      ...
      .setDescription(
        [
          ...
          "Nominations and votes happen in the **Town Voting** thread once Day 1 begins (`/st next-phase` after setup).",
      ...
      .addFields(
        ...
        },
        {
          ...
          value: [
            ...
            "`/st do add-st` promotes a co-storyteller (also adds them to existing player ST threads). Personal ST threads stay private after `/st end`.",
            "`/st do sync-st-threads` invites everyone with the ST role into all player ST threads (retroactive).",
